                ...
                let marker = new google.maps.Marker({
                    ...
                    icon: {
                        ...
                        url: 'data:image/svg+xml;utf-8, \
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  width="64" height="48" viewBox="0 0 24 24"> \
                            <rect rx="2" ry="2" width="64" height="32" style="fill:rgb(255, 158, 44);"/>\
    ...
    function callback(results, status) {
        if (status == google.maps.places.PlacesServiceStatus.OK) {
            ...
            for (let i = 0; i < results.length; i++) {
                ...
                function detailsCallback(detailResults, status){
